...
export const API_ACCESS_RULES: ApiAccessRule[] = [
  ...
  { pattern: /^\/api\/regions\/?$/, method: M.GET, resource: "project_details", action: "read" },
  { pattern: /^\/api\/regions\/?$/, method: M.POST, resource: "project_details", action: "create" },
  { pattern: /^\/api\/regions\/[^/]+\/?$/, method: M.GET, resource: "project_details", action: "read" },
  { pattern: /^\/api\/regions\/[^/]+\/?$/, method: M.PUT, resource: "project_details", action: "update" },
  { pattern: /^\/api\/regions\/[^/]+\/?$/, method: M.DELETE, resource: "project_details", action: "delete" },
