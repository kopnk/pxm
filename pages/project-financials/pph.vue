...
const sectionTotalPph = computed(() =>
  store.loading ? null : store.listTotals.pphSection.taxIdr,
);
...
<template>
  <div class="container-fluid py-4 px-3">
    ...
    >
      <h4 class="text-brand mb-0">PPH</h4>
    </div>
    ...
    <div class="card mb-3 border-0 shadow-sm">
      ...
      >
        ...
        >
          ...
          <span class="text-nowrap">
            <span class="label-prefix">Total Pph</span>
            <span class="fw-semibold">{{ formatCurrencyIdr(sectionTotalPph) }}</span>
          </span>
        </div>
        <button
          type="button"
        ...
        <div class="table-scroll-x">
          ...
          >
            ...
            <tbody>
              ...
              <tr v-if="!store.loading && pphRows.length === 0">
